...
| `beaconEndpoint` ()                    | RUM beacon URL, ex. `https://rum-ingest.<realm>.signalfx.com/v1/rum`. If both `realm` and `beaconEndpoint` are set, `beaconEndpoint` takes precedence. [1] [2] [3]                                          |
| `rumAuth` ()                           | RUM authentication token. [1]                                                                                                                                                                               |
